...
<div class="mk-app">
	...
	<Transition :name="'tray'">
		<div v-if="showMenu" class="menu">
			...
			<div class="action">
				<button class="_buttonPrimary" @click="signup()">{{ instance.signupText || i18n.ts.joinThisServer }}</button>
				<button class="_button" @click="signin()">{{ instance.loginText || i18n.ts.login }}</button>
			</div>
		</div>
	</Transition>
</div>
