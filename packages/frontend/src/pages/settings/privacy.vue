...
const allowFollow = ref($i.allowFollow);
...
const defaultNumberQuoteVisibility = computed(defaultStore.makeGetterSetter('defaultNumberQuoteVisibility'));
const defaultNumberQuoteLocalOnly = computed(defaultStore.makeGetterSetter('defaultNumberQuoteLocalOnly'));
