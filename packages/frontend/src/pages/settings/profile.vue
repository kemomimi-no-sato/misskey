	...
	<div class="_gaps_m">
		...
		<SearchMarker>
			<MkFolder>
				...
				<div class="_gaps_m">
					<SearchMarker :keywords="['fox']">
						<MkSwitch v-model="profile.isFox">
							<template #label><SearchLabel>{{ i18n.ts.flagAsFox }}</SearchLabel></template>
							<template #caption>{{ i18n.ts.flagAsFoxDescription }}</template>
						</MkSwitch>
					</SearchMarker>
