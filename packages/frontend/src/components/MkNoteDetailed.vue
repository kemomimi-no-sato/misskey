	...
	<template v-else>
		<article :class="$style.note" @contextmenu.stop="onContextmenu">
			...
			<footer>
				...
				<button v-if="prefer.s.separateQuoteRenoteButton && canRenote" ref="quoteButton" :class="$style.noteFooterButton" class="_button" @click="quote()">
					<i class="ti ti-quote"></i>
				</button>
				<button v-else-if="prefer.s.separateQuoteRenoteButton && !canRenote" ref="quoteButton" :class="$style.noteFooterButton" class="_button" disabled>
					<i class="ti ti-ban"></i>
				</button>
				...
				<button ref="reactButton" :class="$style.noteFooterButton" class="_button" @click="toggleReact()">
					...
					<i v-else-if="$appearNote.myReaction != null" class="ti ti ti-mood-minus" style="color: var(--MI_THEME-accent);"></i>
					<i v-else-if="appearNote.reactionAcceptance === 'likeOnly'" class="ti ti-heart"></i>
					<i v-else class="ti ti ti-mood-plus"></i>
				...
				<button ref="favButton" :class="$style.noteFooterButton" class="_button" @click="toggleFav()">
					<i v-if="!isFavorited" class="ti ti-star"></i>
					<i v-else class="ti ti-star-off"></i>
				</button>
...
import { stealMenu } from '@/utility/steal-menu';
...
import { haptic } from '@/utility/haptic';
...
const stealButton = useTemplateRef('stealButton');
...
const stealButtonVisible = appearNote.text && prefer.s.stealEnabled;
